...
export default function UpdateProduct(){
    ...
    useEffect(()=>{
        ...
        const fetchProduct = async()=>{
            ...
            try{
                const res = await axios.get(`https://mini-e-commerce-website4.onrender.com/api/products/${id}`)
    ...
    const handleSubmit =async(e)=>{
        ...
        try{
            await axios.put(`https://mini-e-commerce-website4.onrender.com/api/products/${id}`,
                formData,
                    ...
                    <form onSubmit={handleSubmit} className="update-form">
                        ...
                        <div className="input-fields">
                            ...
                            {currentImage && (
                                <div>
                                    <img 
                                    src={`https://mini-e-commerce-website4.onrender.com/upload/${currentImage}`} width="100" alt="Current" />
                                </div>
                            )}
                            <input 
                                type="file" 
