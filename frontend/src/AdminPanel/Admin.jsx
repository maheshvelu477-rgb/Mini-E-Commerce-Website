...
export default function Admin() {
  ...
  const handleDeleteProduct = async (product) => {
    ...
    try {
      await axios.delete(`https://mini-e-commerce-website4.onrender.com/api/products/${product._id}`);
      fetchProducts();
    } catch (error) {
          ...
          <div className="product-table">
            ...
            {Products.map((product, index) => (
              <div className="table-row" key={product._id}>
                ...
                <span>
                  <img src={`https://mini-e-commerce-website4.onrender.com/upload/${product.image}`} alt={product.name} />
                </span>
